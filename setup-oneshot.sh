...
echo "ArgoCD URL is: http://$DNS_HOSTNAME/argocd"

echo "GITEA URL is: http://$DNS_HOSTNAME/gitea"

echo "Keycloak URL is: http://$DNS_HOSTNAME/keycloak"

echo "Backstage URL is: http://$DNS_HOSTNAME/"

echo "ArgoWorkflows URL is: http://$DNS_HOSTNAME/argo-workflows"
